...
{:else}
<span class="cta-icon">{iconMap[type]}</span>
{/if}
<span class="cta-label">{content.label}</span>
</a>

<style lang="postcss">
.cta-block {
@apply flex items-center justify-center gap-3 px-6 py-4 rounded-xl font-semibold text-center transition-all duration-200;

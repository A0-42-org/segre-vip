...
<div class="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 px-4">
  <div class="w-full max-w-md">
    <div class="card bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 text-center">
      <!-- Error Icon -->
      <div class="mb-6 flex justify-center">
        <div class="flex h-24 w-24 items-center justify-center rounded-full bg-error-10 dark:bg-error-20">
          <span class="text-5xl font-bold text-error-500">{status}</span>
        </div>
      </div>
